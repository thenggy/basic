...
class P_Path(Node):
    ...
    def lidar_callback(self, msg):
        print(msg.ranges[512])
        self.obstacle_detected = False
        for i in range (100):
            if msg.ranges[512 - i] < 0.3 or msg.ranges[512 + i] < 0.3:
    ...
    def odom_callback(self, msg):
        ...
        if abs(theta_difference) > 0.6:
            cmd_msg.linear.x = 0.0
            cmd_msg.angular.z = kp_w * theta_difference
        elif abs(theta_difference) < 0.6:
        ...
        if cmd_msg.angular.z > 0.6:
            cmd_msg.angular.z = 0.6
        elif cmd_msg.angular.z < -0.6:
            cmd_msg.angular.z = -0.6
