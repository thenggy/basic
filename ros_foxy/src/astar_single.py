...
class AStarPlanner:
    ...
    def __init__(self, ox, oy, resolution, rr):
        ...
        self.rr = rr
        self.min_x, self.min_y = -50, -50
        self.max_x, self.max_y = 50, 50
...
def remove_close_obstacles(obstacle_x_list, obstacle_y_list, min_distance=0.05):
    new_obstacle_x = []
    new_obstacle_y = []
...
class PathPublisherNode(Node):
    def __init__(self):
        ...
        self.map_subscription = self.create_subscription(OccupancyGrid, '/global_costmap/costmap', self.map_callback, 1)
    ...
    def map_callback(self, msg):
        ...
        for y in range(self.height):
            for x in range(self.width):
                ...
                if cell_value > 25 and cell_value < 30:
                    obstacle_x = self.origin.position.x + (x + 0.5) * self.resolution - self.map_to_odom_x
        ...
        self.ox, self.oy = remove_close_obstacles(self.ox, self.oy)
